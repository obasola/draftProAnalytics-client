...
<style scoped>
.login-page {
  background: #0f172a; /* deep slate so the card pops */
}

/* Card/form background — complementary warm tone to #254290 */
.login-card {
  background-color: #f1e0a3; /* soft gold */

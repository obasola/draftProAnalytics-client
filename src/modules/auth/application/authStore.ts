...
import type {
  ...
  AssignedRole,
  PermissionMap,
} from '@/modules/accessControl/domain/access.types'
import {
  getMyAccessContext,
  assumeRole as apiAssumeRole,
} from '@/modules/accessControl/application/api/accessControlApi'
import { loginWithAppleUseCase } from './usecases/loginWithAppleUseCase'
...
export const useAuthStore = defineStore('auth', () => {
  ...
  async function loginWithGoogle(credential: string): Promise<void> {
    const result = await loginWithGoogleUseCase(credential)
